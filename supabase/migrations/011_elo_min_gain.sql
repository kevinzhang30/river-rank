-- Enforce a minimum Elo gain of 5 for the winner (and minimum loss of 5 for the loser).
-- This prevents wins from rounding to 0 delta when there is a large rating gap.
